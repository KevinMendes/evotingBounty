...
module.exports = InvalidEncodingKeyPair;

/**
 * Defines an RSA key pair for which the PEM encoding is invalid.
 */
function InvalidEncodingKeyPair() {
	const PUBLIC_KEY = [
		'-----BEGIN PUBLIC KEY-----',
		'INVALID_PEM_ENCODIING_QUAA4GNADCBiQKBgQC36qScl38p2jT1+9CtFOGqH/c',
		...
		'CUKe7IYpePUt/MNxHwIDAQAB', '-----END PUBLIC KEY-----'
	].join('\n');

	const PRIVATE_KEY = [
		'-----BEGIN RSA PRIVATE KEY-----',
		'INVALID_PEM_ENCODIING_45bnf2opnRI+Y51VqouBpvDT33xIB/OtbwKzwVpi+J',
