...
/**
 * Enum which defines the encryption key pair algorithms and their specification.
 *
 ...
 */
public enum ConfigEncryptionKeyPairAlgorithmAndSpec {
	...
	ConfigEncryptionKeyPairAlgorithmAndSpec(final String algorithm, final AlgorithmParameterSpec algorithmParameterSpec, final Provider provider) {
