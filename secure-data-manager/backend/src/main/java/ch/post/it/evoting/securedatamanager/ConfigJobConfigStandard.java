...
import ch.post.it.evoting.securedatamanager.batch.batch.writers.StandardPrintingDataWriter;
...
public class ConfigJobConfigStandard extends ConfigJobConfig {
	...
	CompositeOutputWriter compositeOutputWriter(final CommonBatchInfrastructure commonBatchInfrastructure,
		...
		writer.setDelegates(Arrays.asList(
				...
				printingDataWriter(commonBatchInfrastructure, outputPath, votingCardSetId, verificationCardSetId),
	...
	private StandardPrintingDataWriter printingDataWriter(final CommonBatchInfrastructure commonBatchInfrastructure, final String baseOutputPath,
			final String votingCardSetId, final String verificationCardSetId) {
