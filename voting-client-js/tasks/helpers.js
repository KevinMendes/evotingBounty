...
const getCommandArguments = function () {
 ...
 */
const notification = function (title, message, isError, onLast) {
 ...
 */
const notificationOnError = function (title, message) {
...
const gulpNotify = function (title, message) {
 ...
 * );
 */
const notificationTask = function (taskName, title, message) {
 ...
 */
const handleTaskSequenceError = function (done) {
...
module.exports = {
	...
	handleTaskSequenceError: handleTaskSequenceError,
};
