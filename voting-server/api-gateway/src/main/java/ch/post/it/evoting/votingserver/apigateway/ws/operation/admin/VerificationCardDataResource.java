...
public class VerificationCardDataResource {
	...
	static final String VERIFICATION_CARD_DATA_PATH = PROPERTIES.getPropertyValue("VERIFICATION_CARD_DATA_PATH");
	...
	@Inject
	VerificationCardDataResource(VoteVerificationAdminClient voteVerificationAdminClient, TrackIdGenerator trackIdGenerator) {
	...
	public Response saveVerificationCardData(
		...
		try (ResponseBody responseBody = RetrofitConsumer.processResponse(voteVerificationAdminClient
				.saveVerificationCardData(VERIFICATION_CARD_DATA_PATH, tenantId, electionEventId, verificationCardSetId, adminBoardId, xForwardedFor,
						trackingId, body))) {
