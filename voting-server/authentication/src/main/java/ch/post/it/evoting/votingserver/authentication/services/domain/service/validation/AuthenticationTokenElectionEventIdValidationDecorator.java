 ...
 */
@Decorator
public abstract class AuthenticationTokenElectionEventIdValidationDecorator implements AuthenticationTokenValidation {

	@Inject
	@Delegate
	private AuthenticationTokenElectionEventIdValidation authenticationTokenElectionEventIdValidation;
	...
	public ValidationResult execute(String tenantId, String electionEventId, String votingCardId, AuthenticationToken authenticationToken)
		...
		return authenticationTokenElectionEventIdValidation.execute(tenantId, electionEventId, votingCardId, authenticationToken);
	}
