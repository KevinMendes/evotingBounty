...
public class EntryPersistenceException extends Exception {
	 ...
	 */
	public EntryPersistenceException(final String message) {
		super(message);
	}
	 ...
	 */
	public EntryPersistenceException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 */
	public EntryPersistenceException(final String message, final String resource, final String errorCode) {
		super(message);
