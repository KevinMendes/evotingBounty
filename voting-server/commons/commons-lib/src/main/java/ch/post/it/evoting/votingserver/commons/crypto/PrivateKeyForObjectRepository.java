...
public class PrivateKeyForObjectRepository {
	 ...
	 */
	public PrivateKeyForObjectRepository(final KeystoreForObjectOpener keystoreOpener, final PasswordForObjectRepository passwordRepository) {
	 ...
	 */
	public PrivateKey findByTenantEEIDObjectIdAlias(final String tenantId, final String eeId, final String objectId, final String alias)
		...
		try {
			final CryptoAPIExtendedKeyStore keystore = keystoreOpener.openForTenantEEIDObjectId(tenantId, eeId, objectId);
