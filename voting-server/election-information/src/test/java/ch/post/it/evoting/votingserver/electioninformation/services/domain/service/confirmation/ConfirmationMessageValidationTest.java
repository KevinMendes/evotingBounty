...
public class ConfirmationMessageValidationTest {
	...
	private AuthenticationToken fakeAuthenticationToken() {
		...
		final VoterInformation voterInfo = new VoterInformation();
		voterInfo.setBallotBoxId("e20bfdb00cc0427698a9578099e54ca3");
		token.setVoterInformation(voterInfo);
		return token;
	}

	private ConfirmationInformation fakeConfirmationInformation(final String key) {
		final ConfirmationInformation information = new ConfirmationInformation();
		final ConfirmationMessage message = new ConfirmationMessage();
	...
	private BallotBoxInformation fakeBallotBoxInformationWithInvalidEncryptionParameters() {
		final BallotBoxInformation ballotBoxInformation = new BallotBoxInformation();
		ballotBoxInformation.setJson(
				"{\"eeid\":\"dbe163434b654a2a9565057d5f555dfe\",\"startDate\":\"2016-10-27T08:00Z\",\"endDate\":\"2017-04-01T20:00Z\",\"encryptionParameters\":{\"p\":\"a;123\",\"q\":\"b%123123\",\"g\":\"2\"},\"test\":true,\"gracePeriod\":\"600\",\"bid\":\"5e4ea1721f5f4699a5373a5da017f4bf\",\"electoralAuthorityId\":\"46ec4ea7c32449b58562f0e8fb7452e8\",\"id\":\"e20bfdb00cc0427698a9578099e54ca3\"}");
		return ballotBoxInformation;
	}
