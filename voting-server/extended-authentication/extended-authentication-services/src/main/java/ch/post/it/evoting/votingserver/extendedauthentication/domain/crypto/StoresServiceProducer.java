...
public class StoresServiceProducer {
	...
	/**
	 * Returns a keystore store service.
	 *
	 * @return a keystore store service instance.
	 */
	@Produces
	@ApplicationScoped
	public KeyStoreService getInstance() {
		...
		try {
			...
			throw new IllegalStateException("Exception while trying to create KeyStoreService", e);
		}
	}
}
