...
@Component
public class ReturnCodesLVCCShareContributionsConsumer {

	private final CommandFacade commandFacade;
	private final ObjectMapper objectMapper;
	private final AggregatorService aggregatorService;

	public ReturnCodesLVCCShareContributionsConsumer(final CommandFacade commandFacade,
	...
	@RabbitListener(queues = "#{queueNameResolver.get(\"CREATE_LVCC_SHARE_RESPONSE_PATTERN\")}")
	public void consumer(final Message message) throws IOException {
		...
		final LongReturnCodesSharePayload longReturnCodesSharePayload = objectMapper.readValue(encodedResponse, LongReturnCodesSharePayload.class);
		...
		final int nodeId = longReturnCodesShare.getNodeId();
		commandFacade.saveResponse(encodedResponse, correlationId, contextId, Context.VOTING_RETURN_CODES_CREATE_LVCC_SHARE, nodeId);
