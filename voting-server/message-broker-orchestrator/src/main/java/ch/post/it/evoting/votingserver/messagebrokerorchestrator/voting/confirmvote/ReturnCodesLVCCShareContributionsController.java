...
@RestController
@RequestMapping("/api/v1/voting/confirmvote")
public class ReturnCodesLVCCShareContributionsController {

	private final ObjectMapper objectMapper;
	private final BroadcastProducerService broadcastProducerService;

	public ReturnCodesLVCCShareContributionsController(
	...
	@PostMapping("/lvccshare/electionevent/{electionEventId}/verificationCardSetId/{verificationCardSetId}/verificationCardId/{verificationCardId}")
	public List<LongReturnCodesSharePayload> getLongChoiceReturnCodesContributions(
		...
		return broadcastProducerService.sendMessagesAwaitingNotification(contextId, Context.VOTING_RETURN_CODES_CREATE_LVCC_SHARE,
				confirmationKeyPayload, CREATE_LVCC_SHARE_REQUEST_PATTERN, this::deserializePayload);
	}
