...
public final class OrTenantFilter implements Filter {

	private static final Logger LOGGER = LoggerFactory.getLogger(OrTenantFilter.class);
	...
	public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain filterChain)
		...
		if (orTenantSystemKeys.getInitialized(tenantID)) {
	...
	@Override
	public void destroy() {
		LOGGER.info("OR - destroying filter");
	}
}
