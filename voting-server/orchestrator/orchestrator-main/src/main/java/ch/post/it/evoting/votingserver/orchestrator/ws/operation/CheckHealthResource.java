 ...
 */
@Stateless(name = "orchestratorCheckHealth")
@Path(CheckHealthResource.RESOURCE_PATH)
@TransactionAttribute(TransactionAttributeType.NOT_SUPPORTED)
public class CheckHealthResource {

	public static final String RESOURCE_PATH = "check";
	 ...
	 * <p>
	 * Despite being useful for validating the state of the application, some health checks (logging initialized or not) aren't necessary to identify
	 * if the service has been properly deployed.
	 *
	 * @return Returns an HTTP Status code 200, if all health checks are ok, 503 if any has failed
	 */
	@GET
