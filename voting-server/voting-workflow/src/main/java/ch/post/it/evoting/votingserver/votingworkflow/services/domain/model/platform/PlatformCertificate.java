...
public class PlatformCertificate extends PlatformCAEntity {
	...
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "platformCertificatesSeq")
	@SequenceGenerator(name = "platformCertificatesSeq", sequenceName = "PLATFORM_CERTIFICATE_SEQ", allocationSize = 1)
	@JsonIgnore
	private Long id;
